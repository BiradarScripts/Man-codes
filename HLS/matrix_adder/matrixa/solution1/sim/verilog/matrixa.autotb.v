...
`define AUTOTB_DUT      matrixa
`define AUTOTB_DUT_INST AESL_inst_matrixa
`define AUTOTB_TOP      apatb_matrixa_top
`define AUTOTB_LAT_RESULT_FILE "matrixa.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matrixa.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matrixa_top
...
`define AUTOTB_TVIN_a  "../tv/cdatafile/c.matrixa.autotvin_a.dat"
`define AUTOTB_TVIN_b  "../tv/cdatafile/c.matrixa.autotvin_b.dat"
`define AUTOTB_TVIN_result  "../tv/cdatafile/c.matrixa.autotvin_result.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.matrixa.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.matrixa.autotvin_b.dat"
`define AUTOTB_TVIN_result_out_wrapc  "../tv/rtldatafile/rtl.matrixa.autotvin_result.dat"
`define AUTOTB_TVOUT_result  "../tv/cdatafile/c.matrixa.autotvout_result.dat"
`define AUTOTB_TVOUT_result_out_wrapc  "../tv/rtldatafile/rtl.matrixa.autotvout_result.dat"
module `AUTOTB_TOP;
